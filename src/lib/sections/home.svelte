  ...
  <div class="content-wrapper">
    <div class="flex">
      ...
      <div class="flex-wrapper second">
        <h1 class="title">
          <div class="title-mask">
            <div class="word" bind:this={titleWord1Element}>Df</div>
          </div><br> 
          <div class="title-mask">
            <div class="word" bind:this={titleWord2Element}>Curie</div>
          </div>
        </h1>
        <div class="occupation mask">
          <p class="paragraph" bind:this={shortDetailsElement}>
            Web Designer & Developer from Bandung, Indonesia
          </p>
        </div>
      ...
      <div class="parallax-wrapper home-back" bind:this={backgroundContainerElement}>
        {#await loadImage("assets/imgs/home-bg.jpg") then src}
